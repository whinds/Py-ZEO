...
class ZeoViewer(QtGui.QMainWindow):
    ...
    def __init__(self, parent=None):
        #super(ZeoViewer, self).__init__(parent)
        #self.wave_thread = MyThread(self)
        #self.wave_thread.updated.connect(self.updateWaveform)
